...
func TestMarkController(t *testing.T) {
	t.Run("Run marks todo as done when hideCompleted is false", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: false}, Args: []string{"2", "done"}}}
	...
	t.Run("Run marks todo as done when hideCompleted is true", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: true}, Args: []string{"1", "done"}}}
		got, err := controller.Run()
	...
	t.Run("Run marks todo as done when given d", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: false}, Args: []string{"1", "d"}}}
		got, err := controller.Run()
	...
	t.Run("Run marks todo as not done when given not-done", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: false}, Args: []string{"1", "not-done"}}}
		got, err := controller.Run()
	...
	t.Run("Run marks todo as not done when given not-done", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: false}, Args: []string{"1", "not"}}}
		got, err := controller.Run()
	...
	t.Run("Run with bad index returns error", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: false}, Args: []string{"1000", "not"}}}
	...
	t.Run("Run with bad status returns error", func(t *testing.T) {
		...
		controller := MarkController{Base: Controller{Config: core.Config{Context: "main", HideCompleted: false}, Args: []string{"1", "bad"}}}
		_, err = controller.Run()
